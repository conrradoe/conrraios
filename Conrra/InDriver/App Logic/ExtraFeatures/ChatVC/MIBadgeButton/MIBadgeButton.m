...
- (void) setupBadgeViewWithString:(NSString *)string
{
    ...
    badgeSize.width = badgeSize.width < 16 ? 20 : badgeSize.width + 5;
    badgeSize.width =12;
    badgeSize.height =12;
    ...
    [badgeLabel setFrame:CGRectMake(self.bounds.size.width - 10 + horizontal+7, -(badgeSize.height / 2) - 10 + vertical, badgeSize.width,  badgeSize.width > 25 ? badgeSize.height : badgeSize.width)];
    [self setupBadgeStyle];
