...
open class LinearProgressBar: UIView {
    ...
    //PUBLIC VARS
    open var backgroundProgressBarColor: UIColor = UIColor(red:40.0/255.0, green:40.0/255.0, blue:40.0/255.0, alpha:1.0)
    open var progressBarColor: UIColor = UIColor(red:252/255.0, green: 227.0/255.0, blue:3.0/255.0, alpha:1.0)
    open var heightForLinearBar: CGFloat = 8
