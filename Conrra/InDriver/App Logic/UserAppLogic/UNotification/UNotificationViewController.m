...
@interface UNotificationViewController ()
{
...
@implementation UNotificationViewController
...
- (void)viewDidLoad {
    ...
    [self setUpPullToRefresh];
     [self.lblHeaderTitle setText:[LanguageHelper getStringWithKey:@"k_15_s4_a1_notifications"]];
}
...
-(void) setUIFields{
 ...
 // Pass the selected object to the new view controller.
      if([segue.identifier isEqualToString:StoryBoardUtiles.NOTIFICATION_DETAIL_VC]) {
...
//        cell.backgroundColor =  [Utilities colorWithHexString:@"ffffff"];
//    } else {
//        [cell setBackgroundColor: [Utilities colorWithHexString:@"fafafa"]];
//    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NotificationModel * notificationModel=[self.notifications.data objectAtIndex:indexPath.row];
     ...
     {
         NotificationDetailViewController *vc=(NotificationDetailViewController*)[StoryBoardUtiles viewContollerInMainWithIdentifier:StoryBoardUtiles.NOTIFICATION_DETAIL_VC];
         vc.notificationModel=notificationModel;
