...
- (BOOL) setConstraintConstantAnimated:(CGFloat)constant forAttribute:(NSLayoutAttribute)attribute {
    BOOL boolValue=[self setConstraintConstant:constant forAttribute:attribute];
...
- (void)showByHeight:(int) height isHidden:(BOOL)hidden
{
    [self showView:hidden byAttribute:NSLayoutAttributeHeight height:height];
}
...
- (void)showView:(BOOL)hidden byAttribute:(NSLayoutAttribute)attribute height:(int) height
{
    if (self.hidden != hidden) {
        ...
        if (hidden)
        {
            ...
            [self setConstraintConstant:height forAttribute:attribute];
            self.hidden = NO;
